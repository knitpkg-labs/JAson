// Header downloaded from https://github.com/vivazzi/mql_unit_test/blob/main/Include/unit_test/unit_test.mqh
// unit_test is licensed under MIT, see https://github.com/vivazzi/mql_unit_test/blob/main/LICENSE
